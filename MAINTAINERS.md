...
**Description:** `Provides authentication service for DPN User and internal components.`  
**SPDX-License-Identifier:** `OGL-UK-3.0`  

Current Status: Under NESO Oversight

At present, **there is no actively assigned supplier maintaining this repository**. NESO is currently in the process of engaging new suppliers through its procurement cycle. 

In the meantime:  
- **Bug reports and documentation feedback** will still be reviewed by NESO.  
- **Security vulnerabilities** should be reported via the [responsible disclosure process](./SECURITY.md).  
- **For any queries, please contact:** **[dsi@neso.energy]** 
...
|----------------------|--------------------|---------------------------|-----------------------------------| 
| Anik Biswas          | IBM                | Maintainer                | Anik.Biswas1@neso.energy          |
| Tamanna Saxena       | IBM                | Lead Maintainer           | Tamanna.Saxena@neso.energy        |
| Sourav Ghosh | IBM                | Documentation Contirbutor | Sourav.Ghosh@neso.energy  |     

*For ongoing inquiries, please use the NESO contact email above.* 

---

## How This Repository is Managed  

NESO repositories remain publicly available even when transitioning between suppliers.  
During these times, NESO ensures:  
